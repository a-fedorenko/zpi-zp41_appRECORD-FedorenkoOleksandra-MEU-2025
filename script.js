const labList = {
    ...
    '4': {
        'Тема. Мета. Місце розташування сайту та звіту': './laba_4/links.html',
        'Завдання': './laba_4/task1.html',
    },
    '5': {
        'Тема. Мета. Місце розташування сайту та звіту': './laba_5/links.html',
        'Завдання №1': './laba_5/task1.html',
        'Завдання №2': './laba_5/task2.html',
    },
    '6': {
        'Тема. Мета. Місце розташування сайту та звіту': './laba_6/links.html',
        'Завдання №1': './laba_6/1-timer.html',
        'Завдання №2': './laba_6/2-snackbar.html',
        'Завдання №3': './laba_6/task3.html',
    },
};
